                  ...
                  <tr style={{ borderBottom: '1px solid var(--border-color)', backgroundColor: 'white' }}>
                    ...
                    <td style={{ padding: '1rem', textAlign: 'right' }}>
                      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' }}>
                        <button className="btn" style={{ padding: '0.4rem 0.8rem', backgroundColor: '#25D366', color: 'white', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', fontSize: '0.85rem' }} title="Kirim WA" onClick={() => handleKirimWA(s, studentTagihan)}>
