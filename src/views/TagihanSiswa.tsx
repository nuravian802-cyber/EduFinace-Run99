                  ...
                  <tr style={{ borderBottom: '1px solid var(--border-color)', backgroundColor: 'white' }}>
                    ...
                    <td style={{ padding: '1rem', textAlign: 'right' }}>
                      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem' }}>
                        <button className="btn btn-outline" style={{ padding: '0.4rem', color: '#25D366', borderColor: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Kirim WA" onClick={() => handleKirimWA(s, studentTagihan)}>
